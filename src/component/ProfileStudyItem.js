...
function ProfileStudyItem(props) {
    ...
    return (
        <>
            <div onClick={handleItemClick} className="border col-3 d-flex" style={{ padding: "8px", borderWidth: "2px", borderColor: "pink", borderBlockStyle: "solid", borderRadius: "0.5rem", background: "white",width:"25%" ,margin:" 0px 6% 10px 0px"}}>
...
export default ProfileStudyItem