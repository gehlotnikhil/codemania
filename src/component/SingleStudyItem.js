...
function SingleStudyItem() {
  ...
  useEffect(() => {
    ...
    switch (parseInt(context.questionItemNo)) {
        ...
        <div style={{ width: "50%" }} className='mx-5'>
          ...
          <div className="my-5">
            ...
            <div className={`mx-2 d-flex my-2 ${studyItemRelated.topR}`} style={{ margin: "0.8rem 0.5rem", flexDirection: "row" }}>
              ...
              <Link   className="mx-2 my-2">Top Interview 50</Link>
            </div>
            <div className={`mx-2 d-flex my-2 ${studyItemRelated.code25}`} style={{ margin: "0.8rem 0.5rem", flexDirection: "row" }}>
              ...
              <Link   className="mx-2 my-2">Codemania-25</Link>
            </div>
            ...
            <div className={`mx-2 d-flex my-2 ${studyItemRelated.amazonR}`} style={{ margin: "0.8rem 0.5rem", flexDirection: "row" }}>
              ...
              <Link  className="mx-2 my-2">Amazon Spring 23 High Frequency</Link>
            </div>
            <div className={`mx-2 d-flex my-2 ${studyItemRelated.googleR}`} style={{ margin: "0.8rem 0.5rem", flexDirection: "row", position: "relative", top: "-12px" }}>
              <img src="images/question_item_6.png" alt="" height="50px" width="50px" />
              <Link  className="mx-2 my-1">Google Spring 23 High Frequency</Link>
            </div>
          </div>
        </div>
      </div>
