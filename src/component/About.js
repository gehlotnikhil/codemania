  ...
  return (
    <div>
      <div className="container">
        ...
        <h3 className="heading">About Codemania:</h3>
        <div className="container">
          <div className="container">
            <h5 className="heading">1. Company Profile and Brand:</h5>
            <p className="paragraph">
              Codemania is a leading platform that provides computer science
              ...
              Codemania is committed to promoting technological advancement and
          ...
          <div className="container">
            ...
            <p className="paragraph">
              Codemania was founded in 2023 by Nikhil Gehlot with a vision to
              ...
              technology landscape. Codemania aspires to be the definitive
          ...
          <div className="container">
            ...
            <p className="paragraph">
              ...
              coding and education, laid the very bedrock upon which Codemania
              ...
              a vital catalyst for the remarkable success of Codemania. Shikhar,
